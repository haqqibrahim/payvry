...
const { QrCodeGen } = require("./CreateQRCode");

var mixpanel = Mixpanel.init(process.env.MIXPANEL_TOKEN);

exports.dinnerConfirmTransactionPage = async (req, res) => {
  try {
...
// Aolcls
exports.dinnerConfirmTransaction = async (req, res) => {
  try {
    ...
    await sendMessage(
      `Your payment of Naira ${tx[1].amount} for the Dinner & Award Night is successful`,
      user.phoneNumber
    );
    await sendMessage(
