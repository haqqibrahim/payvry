...
const { dinnerConfirmTransactionPage, dinnerConfirmTransaction } = require("../../Controllers/User/Transaction/DinnerConfirm");
...
router.get("/dinner/confirm/:id", dinnerConfirmTransactionPage)
router.post("/dinner/confirm", dinnerConfirmTransaction)
